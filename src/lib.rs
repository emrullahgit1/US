...
#[derive(Debug)]
pub struct USDTTransferProcessor {
    verbose: bool,
    processed_count: usize,
}

impl USDTTransferProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting USDTTransfer processing");
    
    let mut processor = USDTTransferProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = USDTTransferProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = USDTTransferProcessor::new(false);
